...
hi      Number       guifg=#5fd7ff guibg=NONE    ctermfg=81   ctermbg=NONE gui=NONE cterm=NONE
hi      Boolean      guifg=#5fd7ff guibg=NONE    ctermfg=81   ctermbg=NONE gui=bold cterm=bold
